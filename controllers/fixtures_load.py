...
CREATE TABLE telephone(
   ...
   FOREIGN KEY(modele_id) REFERENCES modele(id_modele)
    ...
    sql='''INSERT INTO couleur(libelle_couleur) VALUES
('couleur unique')
('Noir'),
('Blanc'),
('Jaune'),
...
('Gris');'''
    ...
    sql='''INSERT INTO modele(libelle_modele) VALUES
('Standard'),
('Modèle Pro'),
('Modèle Max'),
('Modèle S');'''
    ...
    sql = ''' INSERT INTO telephone (libelle_telephone, poids_telephone, stockage_telephone, prix_telephone, autonomie_telephone, image_telephone, modele_id) VALUES
...
('Grand');'''
    ...
    sql='''INSERT INTO declinaison (stock, prix_declinaison, telephone_id, taille_id, couleur_id) VALUES
(10, 1299.99, 1, 1, 1),
(10, 1399.99, 1, 2, 1),
(10, 1299.99, 1, 1, 2),
(0, 1399.99, 2, 2, 2),
...
('2024-02-06', 2, 2, '1213 Rue de Rivoli, 75001 Paris, France', '5 Rue de la Paix, 75002 Paris, France');'''
    ...
    sql=''' INSERT INTO ligne_panier(declinaison_id, utilisateur_id, quantite, date_ajout) VALUES
(1, 1, 2, '2024-02-01'),
(2, 2, 1, '2024-02-02'),
(3, 1, 3, '2024-02-03'),
(4, 1, 1, '2024-02-05'),
(5, 2, 4, '2024-02-06');'''
    ...
    sql = '''INSERT INTO ligne_commande(declinaison_id, commande_id, prix, quantite) VALUES
(4, 1, 650, 2),
(5, 1, 700, 1),
(1, 3, 850, 2),
(3, 4, 500, 1),
